...
QT_MOC_LITERAL(3, 19, 10) // "buttonName"

    },
    "Nav\0buttonClicked\0\0buttonName"
};
...
void Nav::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Nav::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Nav::buttonClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Nav::buttonClicked(const QString & _t1)
{
